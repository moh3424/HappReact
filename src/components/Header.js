        ...
        return (
            <div>
                <header className="main-header">
                    <Link to="/dashboard"><a href="faker_url" className="logo">
                        <span classNamename="logo-mini"><b>H</b>DZ</span>
                        <span className="logo-lg"><b>Hirak</b>DZ</span>
                    </a>
                    </Link>
                        ...
                        <small className="pull-right">80%</small>
                                ...
                                <li className="dropdown user user-menu">
                                    <a href="fake_url" className="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        <span className="hidden-xs">Ali la Point</span>
                                    </a>
                                    <ul className="dropdown-menu">
                                        <li className="user-header">
                                            <img src="dist/img/user2-160x160.jpg" className="img-circle" alt="User" />
                                            <p>
                                                Ali la Point - Web Developer
