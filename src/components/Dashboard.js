    ...
    render() {
      ...
      <small>Control panel</small>
                        ...
                        <ol className="breadcrumb">
                            <li><a href="faker_url"><i className="fa fa-dashboard" /> Home</a></li>
                        ...
                        <div className="row">
                            <div className="col-lg-3 col-xs-6">
                                ...
                                <div className="small-box bg-aqua">
                                    ...
                                    <a href="faker_url" className="small-box-footer">More info <i className="fa fa-arrow-circle-right" /></a>
                                </div>
                            </div>
                            {/* ./col */}
                            <div className="col-lg-3 col-xs-6">
                                    ...
                                    <div className="box-header">
                                        ...
                                        <div className="box-tools pull-right">
                                            <ul className="pagination pagination-sm inline">
                                                <li><a href="faker_url">«</a></li>
                                                <li><a href="faker_url">1</a></li>
                                                <li><a href="faker_url">2</a></li>
                                                <li><a href="faker_url">3</a></li>
                                                <li><a href="faker_url">»</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div className="pull-right box-tools">
                                            ...
                                            <div className="btn-group">
                                                ...
                                                <ul className="dropdown-menu pull-right" role="menu">
                                                    <li><a href="faker_url">Add new event</a></li>
                                                    <li><a href="faker_url">Clear events</a></li>
                                                    <li className="divider" />
                                                    <li><a href="faker_url">View calendar</a></li>
                                                </ul>
                                            </div>
